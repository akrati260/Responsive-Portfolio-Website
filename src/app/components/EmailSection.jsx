...
const EmailSection = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const serviceID = "service_9vs2rek";
    const templateID = "template_688x1cm";
    const userID = "3IXI2_0fyZwjhLB1c";
    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2 justify-center sm:justify-center">
          <Link href="https://github.com/akrati260">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/akratisharma26/">
